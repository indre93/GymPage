...
# Workouts:
katies_workout = katie.workouts.create!(
   [
      {date: "20/04/2020", duration: "2 hours", description: "Today's workout consisted of a little bit of everything"},
      {date: "23/04/2020", duration: "1 hour 30 minutes", description: "Feeling super sore today and I love it!"},
      ]
   )

johns_workout = john.workouts.create!(
   [
      {date: "25/04/2020", duration: "1 hour and 30 minutes", description: "Cardio day. Decided to take a day off from weight lifting."},
      {date: "26/04/2020", duration: "30 minutes", description: "Ran out of pre-workout, but I still managed to go to the gym somehow!"},
      ]
   )
...
Routine.create!(
   [
      ...
      {caption: "5 sets / 5 reps", workout_id: 2, exercise_id: 2},
      {caption: "3 sets / 10 reps", workout_id: 1, exercise_id: 3},
      {caption: "2 sets / 15 reps", workout_id: 3, exercise_id: 4},

      {caption: "3 sets / 10 reps", workout_id: 2, exercise_id: 5},
      {caption: "3 sets / 5 reps", workout_id: 2, exercise_id: 6},
      {caption: "3 sets / 15 reps", workout_id: 1, exercise_id: 7},
      {caption: "5 sets / 10 reps", workout_id: 4, exercise_id: 8},

      {caption: "3 sets / 10 reps", workout_id: 4, exercise_id: 9},
      {caption: "3 sets of 2 minutes", workout_id: 1, exercise_id: 10},
      {caption: "3 sets of one minute", workout_id: 2, exercise_id: 11},
      {caption: "5 sets of 15", workout_id: 4, exercise_id: 12},

      {caption: "5 sets / 10 reps", workout_id: 2, exercise_id: 13},
      {caption: "Did it for 5 minutes", workout_id: 3, exercise_id: 14},
      {caption: "5 sets / 10 reps", workout_id: 3, exercise_id: 15},
      {caption: "3 sets of 5 reps", workout_id: 3, exercise_id: 16},

      {caption: "Spent at least 5 minutes doing this, or at least tried to!", workout_id: 4, exercise_id: 17},
      {caption: "Tried this new movement!", workout_id: 1, exercise_id: 18},
      {caption: "First time trying this and loved it!", workout_id: 4, exercise_id: 19},
      {caption: "2 minutes", workout_id: 2, exercise_id: 20},
   ]
)
